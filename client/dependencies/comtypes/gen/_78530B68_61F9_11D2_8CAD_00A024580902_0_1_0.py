...
IMediaLocator._methods_ = [
    COMMETHOD([], HRESULT, 'FindMediaFile',
              ( [], BSTR, 'Input' ),
              ( [], BSTR, 'FilterString' ),
              ( [], POINTER(BSTR), 'pOutput' ),
              ( [], c_int, 'Flags' )),
    COMMETHOD([], HRESULT, 'AddFoundLocation',
              ( [], BSTR, 'DirectoryName' )),
]
################################################################
...
IAMErrorLog._methods_ = [
    COMMETHOD([helpstring('method LogError')], HRESULT, 'LogError',
              ( [], c_int, 'Severity' ),
              ( [], BSTR, 'pErrorString' ),
              ( [], c_int, 'ErrorCode' ),
              ( [], c_int, 'hresult' ),
...
ISampleGrabberCB._methods_ = [
    COMMETHOD([], HRESULT, 'SampleCB',
              ( [], c_double, 'SampleTime' ),
              ( [], POINTER(IMediaSample), 'pSample' )),
    COMMETHOD([], HRESULT, 'BufferCB',
              ( [], c_double, 'SampleTime' ),
...
IXml2Dex._methods_ = [
    COMMETHOD([helpstring('method CreateGraphFromFile')], HRESULT, 'CreateGraphFromFile',
              ( ['out'], POINTER(POINTER(IUnknown)), 'ppGraph' ),
              ( [], POINTER(IUnknown), 'pTimeline' ),
              ( [], BSTR, 'Filename' )),
    COMMETHOD([helpstring('method WriteGrfFile')], HRESULT, 'WriteGrfFile',
              ( [], POINTER(IUnknown), 'pGraph' ),
              ( [], BSTR, 'Filename' )),
    COMMETHOD([helpstring('method WriteXMLFile')], HRESULT, 'WriteXMLFile',
              ( [], POINTER(IUnknown), 'pTimeline' ),
              ( [], BSTR, 'Filename' )),
    COMMETHOD([helpstring('method ReadXMLFile')], HRESULT, 'ReadXMLFile',
              ( [], POINTER(IUnknown), 'pTimeline' ),
              ( [], BSTR, 'XMLName' )),
    COMMETHOD([helpstring('method Delete')], HRESULT, 'Delete',
              ( [], POINTER(IUnknown), 'pTimeline' ),
              ( [], c_double, 'dStart' ),
              ( [], c_double, 'dEnd' )),
    COMMETHOD([helpstring('method WriteXMLPart')], HRESULT, 'WriteXMLPart',
              ( [], POINTER(IUnknown), 'pTimeline' ),
              ( [], c_double, 'dStart' ),
              ( [], c_double, 'dEnd' ),
              ( [], BSTR, 'Filename' )),
    COMMETHOD([helpstring('method PasteXMLFile')], HRESULT, 'PasteXMLFile',
              ( [], POINTER(IUnknown), 'pTimeline' ),
              ( [], c_double, 'dStart' ),
              ( [], BSTR, 'Filename' )),
    COMMETHOD([helpstring('method CopyXML')], HRESULT, 'CopyXML',
              ( [], POINTER(IUnknown), 'pTimeline' ),
              ( [], c_double, 'dStart' ),
              ( [], c_double, 'dEnd' )),
    COMMETHOD([helpstring('method PasteXML')], HRESULT, 'PasteXML',
              ( [], POINTER(IUnknown), 'pTimeline' ),
              ( [], c_double, 'dStart' )),
    COMMETHOD([helpstring('method Reset')], HRESULT, 'Reset'),
    COMMETHOD([helpstring('method ReadXML')], HRESULT, 'ReadXML',
              ( [], POINTER(IUnknown), 'pTimeline' ),
              ( [], POINTER(IUnknown), 'pxml' )),
    COMMETHOD([helpstring('method WriteXML')], HRESULT, 'WriteXML',
              ( [], POINTER(IUnknown), 'pTimeline' ),
...
IAMTimelineEffectable._methods_ = [
    COMMETHOD([helpstring('method EffectInsBefore')], HRESULT, 'EffectInsBefore',
              ( [], POINTER(IAMTimelineObj), 'pFX' ),
              ( [], c_int, 'priority' )),
    COMMETHOD([helpstring('method EffectSwapPriorities')], HRESULT, 'EffectSwapPriorities',
              ( [], c_int, 'PriorityA' ),
              ( [], c_int, 'PriorityB' )),
    COMMETHOD([helpstring('method EffectGetCount')], HRESULT, 'EffectGetCount',
              ( [], POINTER(c_int), 'pCount' )),
    COMMETHOD([helpstring('method GetEffect')], HRESULT, 'GetEffect',
...
IDXEffect._methods_ = [
    COMMETHOD([dispid(10000), 'propget'], HRESULT, 'Capabilities',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(10001), 'propget'], HRESULT, 'Progress',
              ( ['out', 'retval'], POINTER(c_float), 'pVal' )),
    COMMETHOD([dispid(10001), 'propput'], HRESULT, 'Progress',
              ( ['in'], c_float, 'pVal' )),
    COMMETHOD([dispid(10002), 'propget'], HRESULT, 'StepResolution',
              ( ['out', 'retval'], POINTER(c_float), 'pVal' )),
    COMMETHOD([dispid(10003), 'propget'], HRESULT, 'Duration',
              ( ['out', 'retval'], POINTER(c_float), 'pVal' )),
    COMMETHOD([dispid(10003), 'propput'], HRESULT, 'Duration',
              ( ['in'], c_float, 'pVal' )),
]
################################################################
...
IDxtCompositor._methods_ = [
    COMMETHOD([dispid(1), helpstring('property OffsetX'), 'propget'], HRESULT, 'OffsetX',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(1), helpstring('property OffsetX'), 'propput'], HRESULT, 'OffsetX',
              ( ['in'], c_int, 'pVal' )),
    COMMETHOD([dispid(2), helpstring('property OffsetY'), 'propget'], HRESULT, 'OffsetY',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(2), helpstring('property OffsetY'), 'propput'], HRESULT, 'OffsetY',
              ( ['in'], c_int, 'pVal' )),
    COMMETHOD([dispid(3), helpstring('property Width'), 'propget'], HRESULT, 'Width',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(3), helpstring('property Width'), 'propput'], HRESULT, 'Width',
              ( ['in'], c_int, 'pVal' )),
    COMMETHOD([dispid(4), helpstring('property Height'), 'propget'], HRESULT, 'Height',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(4), helpstring('property Height'), 'propput'], HRESULT, 'Height',
              ( ['in'], c_int, 'pVal' )),
    COMMETHOD([dispid(5), helpstring('property SrcOffsetX'), 'propget'], HRESULT, 'SrcOffsetX',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(5), helpstring('property SrcOffsetX'), 'propput'], HRESULT, 'SrcOffsetX',
              ( ['in'], c_int, 'pVal' )),
    COMMETHOD([dispid(6), helpstring('property SrcOffsetY'), 'propget'], HRESULT, 'SrcOffsetY',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(6), helpstring('property SrcOffsetY'), 'propput'], HRESULT, 'SrcOffsetY',
              ( ['in'], c_int, 'pVal' )),
    COMMETHOD([dispid(7), helpstring('property SrcWidth'), 'propget'], HRESULT, 'SrcWidth',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(7), helpstring('property SrcWidth'), 'propput'], HRESULT, 'SrcWidth',
              ( ['in'], c_int, 'pVal' )),
    COMMETHOD([dispid(8), helpstring('property SrcHeight'), 'propget'], HRESULT, 'SrcHeight',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(8), helpstring('property SrcHeight'), 'propput'], HRESULT, 'SrcHeight',
              ( ['in'], c_int, 'pVal' )),
]
################################################################
...
IAMTimelineSplittable._methods_ = [
    COMMETHOD([], HRESULT, 'SplitAt',
              ( [], c_longlong, 'Time' )),
    COMMETHOD([], HRESULT, 'SplitAt2',
              ( [], c_double, 'Time' )),
]
################################################################
...
IAMTimelineTrans._methods_ = [
    COMMETHOD([helpstring('method GetCutPoint')], HRESULT, 'GetCutPoint',
              ( [], POINTER(c_longlong), 'pTLTime' )),
    COMMETHOD([helpstring('method GetCutPoint2')], HRESULT, 'GetCutPoint2',
              ( [], POINTER(c_double), 'pTLTime' )),
    COMMETHOD([helpstring('method SetCutPoint')], HRESULT, 'SetCutPoint',
              ( [], c_longlong, 'TLTime' )),
    COMMETHOD([helpstring('method SetCutPoint2')], HRESULT, 'SetCutPoint2',
              ( [], c_double, 'TLTime' )),
    COMMETHOD([helpstring('method GetSwapInputs')], HRESULT, 'GetSwapInputs',
              ( [], POINTER(c_int), 'pVal' )),
    COMMETHOD([helpstring('method SetSwapInputs')], HRESULT, 'SetSwapInputs',
              ( [], c_int, 'pVal' )),
    COMMETHOD([helpstring('method GetCutsOnly')], HRESULT, 'GetCutsOnly',
              ( [], POINTER(c_int), 'pVal' )),
    COMMETHOD([helpstring('method SetCutsOnly')], HRESULT, 'SetCutsOnly',
              ( [], c_int, 'pVal' )),
]
################################################################
...
class _AMMediaType(Structure):
    pass
IMediaDet._methods_ = [
    COMMETHOD(['propget', helpstring('property Filter')], HRESULT, 'Filter',
              ( ['out', 'retval'], POINTER(POINTER(IUnknown)), 'pVal' )),
    COMMETHOD(['propput', helpstring('property Filter')], HRESULT, 'Filter',
              ( ['in'], POINTER(IUnknown), 'pVal' )),
    COMMETHOD(['propget', helpstring('property OutputStreams')], HRESULT, 'OutputStreams',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD(['propget', helpstring('property CurrentStream')], HRESULT, 'CurrentStream',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD(['propput', helpstring('property CurrentStream')], HRESULT, 'CurrentStream',
              ( ['in'], c_int, 'pVal' )),
    COMMETHOD(['propget', helpstring('property StreamType')], HRESULT, 'StreamType',
              ( ['out', 'retval'], POINTER(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.GUID), 'pVal' )),
    COMMETHOD(['propget', helpstring('property StreamTypeB')], HRESULT, 'StreamTypeB',
              ( ['out', 'retval'], POINTER(BSTR), 'pVal' )),
    COMMETHOD(['propget', helpstring('property StreamLength')], HRESULT, 'StreamLength',
              ( ['out', 'retval'], POINTER(c_double), 'pVal' )),
    COMMETHOD(['propget', helpstring('property Filename')], HRESULT, 'Filename',
              ( ['out', 'retval'], POINTER(BSTR), 'pVal' )),
    COMMETHOD(['propput', helpstring('property Filename')], HRESULT, 'Filename',
              ( ['in'], BSTR, 'pVal' )),
    COMMETHOD([helpstring('method GetBitmapBits')], HRESULT, 'GetBitmapBits',
              ( [], c_double, 'streamTime' ),
              ( [], POINTER(c_int), 'pBufferSize' ),
              ( [], POINTER(c_ubyte), 'pBuffer' ),
              ( [], c_int, 'Width' ),
              ( [], c_int, 'Height' )),
    COMMETHOD([helpstring('method WriteBitmapBits')], HRESULT, 'WriteBitmapBits',
              ( [], c_double, 'streamTime' ),
              ( [], c_int, 'Width' ),
              ( [], c_int, 'Height' ),
              ( [], BSTR, 'Filename' )),
    COMMETHOD(['propget', helpstring('property StreamMediaType')], HRESULT, 'StreamMediaType',
              ( ['out', 'retval'], POINTER(_AMMediaType), 'pVal' )),
    COMMETHOD([helpstring('method GetSampleGrabber')], HRESULT, 'GetSampleGrabber',
              ( ['out'], POINTER(POINTER(ISampleGrabber)), 'ppVal' )),
    COMMETHOD(['propget', helpstring('property FrameRate')], HRESULT, 'FrameRate',
              ( ['out', 'retval'], POINTER(c_double), 'pVal' )),
    COMMETHOD([helpstring('method EnterBitmapGrabMode')], HRESULT, 'EnterBitmapGrabMode',
              ( [], c_double, 'SeekTime' )),
]
################################################################
...
IResize._methods_ = [
    ...
    COMMETHOD([], HRESULT, 'get_InputSize',
              ( ['out'], POINTER(c_int), 'piHeight' ),
              ( ['out'], POINTER(c_int), 'piWidth' )),
    COMMETHOD([], HRESULT, 'put_Size',
              ( ['in'], c_int, 'Height' ),
              ( ['in'], c_int, 'Width' ),
              ( ['in'], c_int, 'Flag' )),
    COMMETHOD([], HRESULT, 'get_MediaType',
              ( ['out'], POINTER(_AMMediaType), 'pmt' )),
    COMMETHOD([], HRESULT, 'put_MediaType',
...
IAMTimelineSrc._methods_ = [
    COMMETHOD([helpstring('method GetMediaTimes')], HRESULT, 'GetMediaTimes',
              ( [], POINTER(c_longlong), 'pStart' ),
              ( [], POINTER(c_longlong), 'pStop' )),
    COMMETHOD([helpstring('method GetMediaTimes2')], HRESULT, 'GetMediaTimes2',
              ( [], POINTER(c_double), 'pStart' ),
              ( [], POINTER(c_double), 'pStop' )),
    COMMETHOD([helpstring('method ModifyStopTime')], HRESULT, 'ModifyStopTime',
              ( [], c_longlong, 'Stop' )),
    COMMETHOD([helpstring('method ModifyStopTime2')], HRESULT, 'ModifyStopTime2',
              ( [], c_double, 'Stop' )),
    COMMETHOD([helpstring('method FixMediaTimes')], HRESULT, 'FixMediaTimes',
              ( [], POINTER(c_longlong), 'pStart' ),
              ( [], POINTER(c_longlong), 'pStop' )),
    COMMETHOD([helpstring('method FixMediaTimes2')], HRESULT, 'FixMediaTimes2',
              ( [], POINTER(c_double), 'pStart' ),
              ( [], POINTER(c_double), 'pStop' )),
    COMMETHOD([helpstring('method SetMediaTimes')], HRESULT, 'SetMediaTimes',
              ( [], c_longlong, 'Start' ),
              ( [], c_longlong, 'Stop' )),
    COMMETHOD([helpstring('method SetMediaTimes2')], HRESULT, 'SetMediaTimes2',
              ( [], c_double, 'Start' ),
              ( [], c_double, 'Stop' )),
    COMMETHOD([helpstring('method SetMediaLength')], HRESULT, 'SetMediaLength',
              ( [], c_longlong, 'Length' )),
    COMMETHOD([helpstring('method SetMediaLength2')], HRESULT, 'SetMediaLength2',
              ( [], c_double, 'Length' )),
    COMMETHOD([helpstring('method GetMediaLength')], HRESULT, 'GetMediaLength',
              ( [], POINTER(c_longlong), 'pLength' )),
    COMMETHOD([helpstring('method GetMediaLength2')], HRESULT, 'GetMediaLength2',
              ( [], POINTER(c_double), 'pLength' )),
    COMMETHOD([helpstring('method GetMediaName')], HRESULT, 'GetMediaName',
              ( ['out', 'retval'], POINTER(BSTR), 'pVal' )),
    COMMETHOD([helpstring('method SetMediaName')], HRESULT, 'SetMediaName',
              ( [], BSTR, 'newVal' )),
    COMMETHOD([helpstring('method SpliceWithNext')], HRESULT, 'SpliceWithNext',
              ( [], POINTER(IAMTimelineObj), 'pNext' )),
    COMMETHOD([helpstring('method GetStreamNumber')], HRESULT, 'GetStreamNumber',
              ( [], POINTER(c_int), 'pVal' )),
    COMMETHOD([helpstring('method SetStreamNumber')], HRESULT, 'SetStreamNumber',
              ( [], c_int, 'Val' )),
    COMMETHOD([], HRESULT, 'IsNormalRate',
              ( [], POINTER(c_int), 'pVal' )),
    COMMETHOD([helpstring('method GetDefaultFPS')], HRESULT, 'GetDefaultFPS',
              ( [], POINTER(c_double), 'pFPS' )),
    COMMETHOD([helpstring('method SetDefaultFPS')], HRESULT, 'SetDefaultFPS',
              ( [], c_double, 'FPS' )),
    COMMETHOD([helpstring('method GetStretchMode')], HRESULT, 'GetStretchMode',
              ( [], POINTER(c_int), 'pnStretchMode' )),
    COMMETHOD([helpstring('method SetStretchMode')], HRESULT, 'SetStretchMode',
              ( [], c_int, 'nStretchMode' )),
]
################################################################
...
IAMTimelineTrack._methods_ = [
    COMMETHOD([helpstring('method SrcAdd')], HRESULT, 'SrcAdd',
              ( [], POINTER(IAMTimelineObj), 'pSource' )),
    COMMETHOD([helpstring('method GetNextSrc')], HRESULT, 'GetNextSrc',
              ( ['out'], POINTER(POINTER(IAMTimelineObj)), 'ppSrc' ),
              ( [], POINTER(c_longlong), 'pInOut' )),
    COMMETHOD([helpstring('method GetNextSrc2')], HRESULT, 'GetNextSrc2',
              ( ['out'], POINTER(POINTER(IAMTimelineObj)), 'ppSrc' ),
              ( [], POINTER(c_double), 'pInOut' )),
    COMMETHOD([helpstring('method MoveEverythingBy')], HRESULT, 'MoveEverythingBy',
              ( [], c_longlong, 'Start' ),
              ( [], c_longlong, 'MoveBy' )),
    COMMETHOD([helpstring('method MoveEverythingBy2')], HRESULT, 'MoveEverythingBy2',
              ( [], c_double, 'Start' ),
              ( [], c_double, 'MoveBy' )),
    COMMETHOD([helpstring('method GetSourcesCount')], HRESULT, 'GetSourcesCount',
              ( [], POINTER(c_int), 'pVal' )),
    COMMETHOD([helpstring('method AreYouBlank')], HRESULT, 'AreYouBlank',
              ( [], POINTER(c_int), 'pVal' )),
    COMMETHOD([helpstring('method GetSrcAtTime')], HRESULT, 'GetSrcAtTime',
              ( ['out'], POINTER(POINTER(IAMTimelineObj)), 'ppSrc' ),
              ( [], c_longlong, 'Time' ),
              ( [], c_int, 'SearchDirection' )),
    COMMETHOD([helpstring('method GetSrcAtTime2')], HRESULT, 'GetSrcAtTime2',
              ( ['out'], POINTER(POINTER(IAMTimelineObj)), 'ppSrc' ),
              ( [], c_double, 'Time' ),
              ( [], c_int, 'SearchDirection' )),
    COMMETHOD([], HRESULT, 'InsertSpace',
              ( [], c_longlong, 'rtStart' ),
              ( [], c_longlong, 'rtEnd' )),
    COMMETHOD([], HRESULT, 'InsertSpace2',
              ( [], c_double, 'rtStart' ),
              ( [], c_double, 'rtEnd' )),
    COMMETHOD([], HRESULT, 'ZeroBetween',
              ( [], c_longlong, 'rtStart' ),
              ( [], c_longlong, 'rtEnd' )),
    COMMETHOD([], HRESULT, 'ZeroBetween2',
              ( [], c_double, 'rtStart' ),
              ( [], c_double, 'rtEnd' )),
    COMMETHOD([], HRESULT, 'GetNextSrcEx',
...
IAMTimelineEffect._methods_ = [
    COMMETHOD([helpstring('method EffectGetPriority')], HRESULT, 'EffectGetPriority',
              ( [], POINTER(c_int), 'pVal' )),
]
################################################################
...
IDxtAlphaSetter._methods_ = [
    COMMETHOD([dispid(1), helpstring('property Alpha'), 'propget'], HRESULT, 'Alpha',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(1), helpstring('property Alpha'), 'propput'], HRESULT, 'Alpha',
              ( ['in'], c_int, 'pVal' )),
    COMMETHOD([dispid(2), helpstring('property AlphaRamp'), 'propget'], HRESULT, 'AlphaRamp',
              ( ['out', 'retval'], POINTER(c_double), 'pVal' )),
    COMMETHOD([dispid(2), helpstring('property AlphaRamp'), 'propput'], HRESULT, 'AlphaRamp',
              ( ['in'], c_double, 'pVal' )),
]
################################################################
...
class IDxtJpeg(IDXEffect):
    ...
    _idlflags_ = ['dual', 'oleautomation']
IDxtJpeg._methods_ = [
    COMMETHOD([dispid(1), helpstring('property MaskNum'), 'propget'], HRESULT, 'MaskNum',
              ( ['out', 'retval'], POINTER(c_int), '__MIDL__IDxtJpeg0000' )),
    COMMETHOD([dispid(1), helpstring('property MaskNum'), 'propput'], HRESULT, 'MaskNum',
              ( ['in'], c_int, '__MIDL__IDxtJpeg0000' )),
    COMMETHOD([dispid(2), helpstring('property MaskName'), 'propget'], HRESULT, 'MaskName',
              ( ['out', 'retval'], POINTER(BSTR), 'pVal' )),
    COMMETHOD([dispid(2), helpstring('property MaskName'), 'propput'], HRESULT, 'MaskName',
              ( ['in'], BSTR, 'pVal' )),
    COMMETHOD([dispid(3), helpstring('property ScaleX'), 'propget'], HRESULT, 'ScaleX',
              ( ['out', 'retval'], POINTER(c_double), '__MIDL__IDxtJpeg0002' )),
    COMMETHOD([dispid(3), helpstring('property ScaleX'), 'propput'], HRESULT, 'ScaleX',
              ( ['in'], c_double, '__MIDL__IDxtJpeg0002' )),
    COMMETHOD([dispid(4), helpstring('property ScaleY'), 'propget'], HRESULT, 'ScaleY',
              ( ['out', 'retval'], POINTER(c_double), '__MIDL__IDxtJpeg0004' )),
    COMMETHOD([dispid(4), helpstring('property ScaleY'), 'propput'], HRESULT, 'ScaleY',
              ( ['in'], c_double, '__MIDL__IDxtJpeg0004' )),
    COMMETHOD([dispid(5), helpstring('property OffsetX'), 'propget'], HRESULT, 'OffsetX',
              ( ['out', 'retval'], POINTER(c_int), '__MIDL__IDxtJpeg0006' )),
    COMMETHOD([dispid(5), helpstring('property OffsetX'), 'propput'], HRESULT, 'OffsetX',
              ( ['in'], c_int, '__MIDL__IDxtJpeg0006' )),
    COMMETHOD([dispid(6), helpstring('property OffsetY'), 'propget'], HRESULT, 'OffsetY',
              ( ['out', 'retval'], POINTER(c_int), '__MIDL__IDxtJpeg0008' )),
    COMMETHOD([dispid(6), helpstring('property OffsetY'), 'propput'], HRESULT, 'OffsetY',
              ( ['in'], c_int, '__MIDL__IDxtJpeg0008' )),
    COMMETHOD([dispid(7), helpstring('property ReplicateX'), 'propget'], HRESULT, 'ReplicateX',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(7), helpstring('property ReplicateX'), 'propput'], HRESULT, 'ReplicateX',
              ( ['in'], c_int, 'pVal' )),
    COMMETHOD([dispid(8), helpstring('property ReplicateY'), 'propget'], HRESULT, 'ReplicateY',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(8), helpstring('property ReplicateY'), 'propput'], HRESULT, 'ReplicateY',
              ( ['in'], c_int, 'pVal' )),
    COMMETHOD([dispid(9), helpstring('property BorderColor'), 'propget'], HRESULT, 'BorderColor',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(9), helpstring('property BorderColor'), 'propput'], HRESULT, 'BorderColor',
              ( ['in'], c_int, 'pVal' )),
    COMMETHOD([dispid(10), helpstring('property BorderWidth'), 'propget'], HRESULT, 'BorderWidth',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(10), helpstring('property BorderWidth'), 'propput'], HRESULT, 'BorderWidth',
              ( ['in'], c_int, 'pVal' )),
    COMMETHOD([dispid(11), helpstring('property BorderSoftness'), 'propget'], HRESULT, 'BorderSoftness',
              ( ['out', 'retval'], POINTER(c_int), 'pVal' )),
    COMMETHOD([dispid(11), helpstring('property BorderSoftness'), 'propput'], HRESULT, 'BorderSoftness',
              ( ['in'], c_int, 'pVal' )),
...
class IGraphBuilder(IFilterGraph):
    ...
    _idlflags_ = []
IGrfCache._methods_ = [
    COMMETHOD([helpstring('method AddFilter')], HRESULT, 'AddFilter',
              ( [], POINTER(IGrfCache), 'ChainedCache' ),
              ( [], c_longlong, 'Id' ),
              ( [], POINTER(IBaseFilter), 'pFilter' ),
              ( [], WSTRING, 'pName' )),
    COMMETHOD([helpstring('method ConnectPins')], HRESULT, 'ConnectPins',
              ( [], POINTER(IGrfCache), 'ChainedCache' ),
              ( [], c_longlong, 'PinID1' ),
              ( [], POINTER(IPin), 'pPin1' ),
              ( [], c_longlong, 'PinID2' ),
              ( [], POINTER(IPin), 'pPin2' )),
    COMMETHOD([helpstring('method SetGraph')], HRESULT, 'SetGraph',
              ( [], POINTER(IGraphBuilder), 'pGraph' )),
    COMMETHOD([helpstring('method DoConnectionsNow')], HRESULT, 'DoConnectionsNow'),
]
################################################################
...
IAMTimelineTransable._methods_ = [
    COMMETHOD([helpstring('method TransAdd')], HRESULT, 'TransAdd',
              ( [], POINTER(IAMTimelineObj), 'pTrans' )),
    COMMETHOD([helpstring('method TransGetCount')], HRESULT, 'TransGetCount',
              ( [], POINTER(c_int), 'pCount' )),
    COMMETHOD([helpstring('method GetNextTrans')], HRESULT, 'GetNextTrans',
              ( ['out'], POINTER(POINTER(IAMTimelineObj)), 'ppTrans' ),
              ( [], POINTER(c_longlong), 'pInOut' )),
    COMMETHOD([helpstring('method GetNextTrans2')], HRESULT, 'GetNextTrans2',
              ( ['out'], POINTER(POINTER(IAMTimelineObj)), 'ppTrans' ),
              ( [], POINTER(c_double), 'pInOut' )),
    COMMETHOD([helpstring('method GetTransAtTime')], HRESULT, 'GetTransAtTime',
              ( ['out'], POINTER(POINTER(IAMTimelineObj)), 'ppObj' ),
              ( [], c_longlong, 'Time' ),
              ( [], c_int, 'SearchDirection' )),
    COMMETHOD([helpstring('method GetTransAtTime2')], HRESULT, 'GetTransAtTime2',
              ( ['out'], POINTER(POINTER(IAMTimelineObj)), 'ppObj' ),
              ( [], c_double, 'Time' ),
              ( [], c_int, 'SearchDirection' )),
]
...
IRenderEngine._methods_ = [
    COMMETHOD([], HRESULT, 'SetTimelineObject',
              ( [], POINTER(IAMTimeline), 'pTimeline' )),
    COMMETHOD([], HRESULT, 'GetTimelineObject',
    ...
    COMMETHOD([], HRESULT, 'SetInterestRange',
              ( [], c_longlong, 'Start' ),
              ( [], c_longlong, 'Stop' )),
    COMMETHOD([], HRESULT, 'SetInterestRange2',
              ( [], c_double, 'Start' ),
              ( [], c_double, 'Stop' )),
    COMMETHOD([], HRESULT, 'SetRenderRange',
              ( [], c_longlong, 'Start' ),
              ( [], c_longlong, 'Stop' )),
    COMMETHOD([], HRESULT, 'SetRenderRange2',
              ( [], c_double, 'Start' ),
              ( [], c_double, 'Stop' )),
    COMMETHOD([], HRESULT, 'GetGroupOutputPin',
              ( [], c_int, 'Group' ),
              ( ['out'], POINTER(POINTER(IPin)), 'ppRenderPin' )),
    COMMETHOD([], HRESULT, 'ScrapIt'),
    COMMETHOD([], HRESULT, 'RenderOutputPins'),
    COMMETHOD([], HRESULT, 'GetVendorString',
              ( ['out', 'retval'], POINTER(BSTR), 'pVendorID' )),
    COMMETHOD([], HRESULT, 'ConnectFrontEnd'),
    COMMETHOD([], HRESULT, 'SetSourceConnectCallback',
              ( [], POINTER(IGrfCache), 'pCallback' )),
    COMMETHOD([], HRESULT, 'SetDynamicReconnectLevel',
              ( [], c_int, 'Level' )),
    COMMETHOD([], HRESULT, 'DoSmartRecompression'),
    COMMETHOD([], HRESULT, 'UseInSmartRecompressionGraph'),
    COMMETHOD([], HRESULT, 'SetSourceNameValidation',
              ( [], BSTR, 'FilterString' ),
...
IAMTimeline._methods_ = [
    COMMETHOD([helpstring('method CreateEmptyNode')], HRESULT, 'CreateEmptyNode',
              ( ['out'], POINTER(POINTER(IAMTimelineObj)), 'ppObj' ),
              ( [], TIMELINE_MAJOR_TYPE, 'Type' )),
    COMMETHOD([], HRESULT, 'AddGroup',
              ( [], POINTER(IAMTimelineObj), 'pGroup' )),
    COMMETHOD([], HRESULT, 'RemGroupFromList',
              ( [], POINTER(IAMTimelineObj), 'pGroup' )),
    COMMETHOD([], HRESULT, 'GetGroup',
              ( ['out'], POINTER(POINTER(IAMTimelineObj)), 'ppGroup' ),
              ( [], c_int, 'WhichGroup' )),
    COMMETHOD([], HRESULT, 'GetGroupCount',
              ( [], POINTER(c_int), 'pCount' )),
    COMMETHOD([], HRESULT, 'ClearAllGroups'),
    COMMETHOD([], HRESULT, 'GetInsertMode',
              ( [], POINTER(c_int), 'pMode' )),
    COMMETHOD([helpstring('method SetInsertMode')], HRESULT, 'SetInsertMode',
              ( [], c_int, 'Mode' )),
    COMMETHOD([helpstring('method EnableTransitions')], HRESULT, 'EnableTransitions',
              ( [], c_int, 'fEnabled' )),
    COMMETHOD([helpstring('method TransitionsEnabled')], HRESULT, 'TransitionsEnabled',
              ( [], POINTER(c_int), 'pfEnabled' )),
    COMMETHOD([helpstring('method EnableEffects')], HRESULT, 'EnableEffects',
              ( [], c_int, 'fEnabled' )),
    COMMETHOD([helpstring('method EffectsEnabled')], HRESULT, 'EffectsEnabled',
              ( [], POINTER(c_int), 'pfEnabled' )),
    COMMETHOD([helpstring('method SetInterestRange')], HRESULT, 'SetInterestRange',
              ( [], c_longlong, 'Start' ),
              ( [], c_longlong, 'Stop' )),
    COMMETHOD([helpstring('method GetDuration')], HRESULT, 'GetDuration',
              ( [], POINTER(c_longlong), 'pDuration' )),
    COMMETHOD([helpstring('method GetDuration2')], HRESULT, 'GetDuration2',
              ( [], POINTER(c_double), 'pDuration' )),
    COMMETHOD([helpstring('method SetDefaultFPS')], HRESULT, 'SetDefaultFPS',
              ( [], c_double, 'FPS' )),
    COMMETHOD([helpstring('method GetDefaultFPS')], HRESULT, 'GetDefaultFPS',
              ( [], POINTER(c_double), 'pFPS' )),
    COMMETHOD([helpstring('method IsDirty')], HRESULT, 'IsDirty',
              ( [], POINTER(c_int), 'pDirty' )),
    COMMETHOD([helpstring('method GetDirtyRange')], HRESULT, 'GetDirtyRange',
              ( [], POINTER(c_longlong), 'pStart' ),
              ( [], POINTER(c_longlong), 'pStop' )),
    COMMETHOD([helpstring('method GetCountOfType')], HRESULT, 'GetCountOfType',
              ( [], c_int, 'Group' ),
              ( [], POINTER(c_int), 'pVal' ),
              ( [], POINTER(c_int), 'pValWithComps' ),
              ( [], TIMELINE_MAJOR_TYPE, 'majortype' )),
    COMMETHOD([], HRESULT, 'ValidateSourceNames',
              ( [], c_int, 'ValidateFlags' ),
              ( [], POINTER(IMediaLocator), 'pOverride' ),
              ( [], LONG_PTR, 'NotifyEventHandle' )),
    COMMETHOD([], HRESULT, 'SetDefaultTransition',
              ( [], POINTER(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.GUID), 'pGuid' )),
    COMMETHOD([], HRESULT, 'GetDefaultTransition',
              ( [], POINTER(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.GUID), 'pGuid' )),
    COMMETHOD([], HRESULT, 'SetDefaultEffect',
              ( [], POINTER(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.GUID), 'pGuid' )),
    COMMETHOD([], HRESULT, 'GetDefaultEffect',
              ( [], POINTER(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.GUID), 'pGuid' )),
    COMMETHOD([], HRESULT, 'SetDefaultTransitionB',
              ( [], BSTR, 'pGuid' )),
    COMMETHOD([], HRESULT, 'GetDefaultTransitionB',
              ( ['out', 'retval'], POINTER(BSTR), 'pGuid' )),
    COMMETHOD([], HRESULT, 'SetDefaultEffectB',
              ( [], BSTR, 'pGuid' )),
    COMMETHOD([], HRESULT, 'GetDefaultEffectB',
              ( ['out', 'retval'], POINTER(BSTR), 'pGuid' )),
]
################################################################
...
IRenderEngine2._methods_ = [
    COMMETHOD([], HRESULT, 'SetResizerGUID',
              ( [], comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.GUID, 'ResizerGuid' )),
]
################################################################
...
IAMTimelineObj._methods_ = [
    COMMETHOD([helpstring('method GetStartStop')], HRESULT, 'GetStartStop',
              ( [], POINTER(c_longlong), 'pStart' ),
              ( [], POINTER(c_longlong), 'pStop' )),
    COMMETHOD([helpstring('method GetStartStop2')], HRESULT, 'GetStartStop2',
              ( [], POINTER(c_double), 'pStart' ),
              ( [], POINTER(c_double), 'pStop' )),
    COMMETHOD([helpstring('method FixTimes')], HRESULT, 'FixTimes',
              ( [], POINTER(c_longlong), 'pStart' ),
              ( [], POINTER(c_longlong), 'pStop' )),
    COMMETHOD([helpstring('method FixTimes2')], HRESULT, 'FixTimes2',
              ( [], POINTER(c_double), 'pStart' ),
              ( [], POINTER(c_double), 'pStop' )),
    COMMETHOD([helpstring('method SetStartStop')], HRESULT, 'SetStartStop',
              ( [], c_longlong, 'Start' ),
              ( [], c_longlong, 'Stop' )),
    COMMETHOD([helpstring('method SetStartStop2')], HRESULT, 'SetStartStop2',
              ( [], c_double, 'Start' ),
              ( [], c_double, 'Stop' )),
    COMMETHOD([helpstring('method GetPropertySetter')], HRESULT, 'GetPropertySetter',
              ( ['out', 'retval'], POINTER(POINTER(IPropertySetter)), 'pVal' )),
    COMMETHOD([helpstring('method SetPropertySetter')], HRESULT, 'SetPropertySetter',
              ( [], POINTER(IPropertySetter), 'newVal' )),
    COMMETHOD([helpstring('method GetSubObject')], HRESULT, 'GetSubObject',
              ( ['out', 'retval'], POINTER(POINTER(IUnknown)), 'pVal' )),
    COMMETHOD([helpstring('method SetSubObject')], HRESULT, 'SetSubObject',
              ( [], POINTER(IUnknown), 'newVal' )),
    COMMETHOD([helpstring('method SetSubObjectGUID')], HRESULT, 'SetSubObjectGUID',
              ( [], comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.GUID, 'newVal' )),
    COMMETHOD([helpstring('method SetSubObjectGUIDByBSTR')], HRESULT, 'SetSubObjectGUIDB',
              ( [], BSTR, 'newVal' )),
    COMMETHOD([helpstring('method GetSubObjectGUID')], HRESULT, 'GetSubObjectGUID',
              ( [], POINTER(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.GUID), 'pVal' )),
    COMMETHOD([helpstring('method GetSubObjectGUIDByBSTR')], HRESULT, 'GetSubObjectGUIDB',
              ( ['out', 'retval'], POINTER(BSTR), 'pVal' )),
    COMMETHOD([helpstring('method GetSubObjectLoaded')], HRESULT, 'GetSubObjectLoaded',
              ( [], POINTER(c_int), 'pVal' )),
    COMMETHOD([helpstring('method GetTimelineType')], HRESULT, 'GetTimelineType',
              ( [], POINTER(TIMELINE_MAJOR_TYPE), 'pVal' )),
    COMMETHOD([helpstring('method SetTimelineType')], HRESULT, 'SetTimelineType',
              ( [], TIMELINE_MAJOR_TYPE, 'newVal' )),
    COMMETHOD([helpstring('method GetUserID')], HRESULT, 'GetUserID',
              ( [], POINTER(c_int), 'pVal' )),
    COMMETHOD([helpstring('method SetUserID')], HRESULT, 'SetUserID',
              ( [], c_int, 'newVal' )),
    COMMETHOD([helpstring('method GetGenID')], HRESULT, 'GetGenID',
              ( [], POINTER(c_int), 'pVal' )),
    COMMETHOD([helpstring('method GetUserName')], HRESULT, 'GetUserName',
              ( ['out', 'retval'], POINTER(BSTR), 'pVal' )),
    COMMETHOD([helpstring('method SetUserName')], HRESULT, 'SetUserName',
              ( [], BSTR, 'newVal' )),
    COMMETHOD([helpstring('method GetUserData')], HRESULT, 'GetUserData',
              ( [], POINTER(c_ubyte), 'pData' ),
              ( [], POINTER(c_int), 'pSize' )),
    COMMETHOD([helpstring('method SetUserData')], HRESULT, 'SetUserData',
              ( [], POINTER(c_ubyte), 'pData' ),
              ( [], c_int, 'Size' )),
    COMMETHOD([helpstring('method GetMuted')], HRESULT, 'GetMuted',
              ( [], POINTER(c_int), 'pVal' )),
    COMMETHOD([helpstring('method SetMuted')], HRESULT, 'SetMuted',
              ( [], c_int, 'newVal' )),
    COMMETHOD([helpstring('method GetLocked')], HRESULT, 'GetLocked',
              ( [], POINTER(c_int), 'pVal' )),
    COMMETHOD([helpstring('method SetLocked')], HRESULT, 'SetLocked',
              ( [], c_int, 'newVal' )),
    COMMETHOD([helpstring('method GetDirtyRange')], HRESULT, 'GetDirtyRange',
              ( [], POINTER(c_longlong), 'pStart' ),
              ( [], POINTER(c_longlong), 'pStop' )),
    COMMETHOD([helpstring('method GetDirtyRange')], HRESULT, 'GetDirtyRange2',
              ( [], POINTER(c_double), 'pStart' ),
              ( [], POINTER(c_double), 'pStop' )),
    COMMETHOD([helpstring('method SetDirtyRange')], HRESULT, 'SetDirtyRange',
              ( [], c_longlong, 'Start' ),
              ( [], c_longlong, 'Stop' )),
    COMMETHOD([helpstring('method SetDirtyRange')], HRESULT, 'SetDirtyRange2',
              ( [], c_double, 'Start' ),
              ( [], c_double, 'Stop' )),
    ...
    COMMETHOD([], HRESULT, 'GetTimelineNoRef',
              ( [], POINTER(POINTER(IAMTimeline)), 'ppResult' )),
    COMMETHOD([], HRESULT, 'GetGroupIBelongTo',
              ( ['out'], POINTER(POINTER(IAMTimelineGroup)), 'ppGroup' )),
    COMMETHOD([], HRESULT, 'GetEmbedDepth',
              ( [], POINTER(c_int), 'pVal' )),
]
################################################################
...
IAMSetErrorLog._methods_ = [
    COMMETHOD(['propget', helpstring('property ErrorLog')], HRESULT, 'ErrorLog',
              ( ['out', 'retval'], POINTER(POINTER(IAMErrorLog)), 'pVal' )),
    COMMETHOD(['propput', helpstring('property ErrorLog')], HRESULT, 'ErrorLog',
...
ISmartRenderEngine._methods_ = [
    COMMETHOD([], HRESULT, 'SetGroupCompressor',
              ( [], c_int, 'Group' ),
              ( [], POINTER(IBaseFilter), 'pCompressor' )),
    COMMETHOD([], HRESULT, 'GetGroupCompressor',
              ( [], c_int, 'Group' ),
              ( [], POINTER(POINTER(IBaseFilter)), 'pCompressor' )),
    COMMETHOD([], HRESULT, 'SetFindCompressorCB',
...
IAMTimelineVirtualTrack._methods_ = [
    COMMETHOD([helpstring('method TrackGetPriority')], HRESULT, 'TrackGetPriority',
...
IAMTimelineComp._methods_ = [
    COMMETHOD([helpstring('method VTrackInsBefore')], HRESULT, 'VTrackInsBefore',
              ( [], POINTER(IAMTimelineObj), 'pVirtualTrack' ),
              ( [], c_int, 'priority' )),
    COMMETHOD([helpstring('method VTrackSwapPriorities')], HRESULT, 'VTrackSwapPriorities',
              ( [], c_int, 'VirtualTrackA' ),
              ( [], c_int, 'VirtualTrackB' )),
    COMMETHOD([helpstring('method VTrackGetCount')], HRESULT, 'VTrackGetCount',
              ( [], POINTER(c_int), 'pVal' )),
    COMMETHOD([helpstring('method GetVTrack')], HRESULT, 'GetVTrack',
    ...
    COMMETHOD([helpstring('method GetCountOfType')], HRESULT, 'GetCountOfType',
              ...
              ( [], POINTER(c_int), 'pValWithComps' ),
              ( [], TIMELINE_MAJOR_TYPE, 'majortype' )),
    COMMETHOD([helpstring('method GetRecursiveLayerOfType')], HRESULT, 'GetRecursiveLayerOfType',
              ( ['out'], POINTER(POINTER(IAMTimelineObj)), 'ppVirtualTrack' ),
              ( [], c_int, 'WhichLayer' ),
              ( [], TIMELINE_MAJOR_TYPE, 'Type' )),
    COMMETHOD([helpstring('method GetRecursiveLayerOfTypeI (do not call)')], HRESULT, 'GetRecursiveLayerOfTypeI',
              ( ['out'], POINTER(POINTER(IAMTimelineObj)), 'ppVirtualTrack' ),
              ( ['in', 'out'], POINTER(c_int), 'pWhichLayer' ),
              ( [], TIMELINE_MAJOR_TYPE, 'Type' )),
    COMMETHOD([], HRESULT, 'GetNextVTrack',
              ( [], POINTER(IAMTimelineObj), 'pVirtualTrack' ),
...
IFindCompressorCB._methods_ = [
    COMMETHOD([], HRESULT, 'GetCompressor',
              ( [], POINTER(_AMMediaType), 'pType' ),
...
IAMTimelineGroup._methods_ = [
    COMMETHOD([helpstring('method SetTimeline')], HRESULT, 'SetTimeline',
              ( [], POINTER(IAMTimeline), 'pTimeline' )),
    COMMETHOD([helpstring('method GetTimeline')], HRESULT, 'GetTimeline',
              ( ['out'], POINTER(POINTER(IAMTimeline)), 'ppTimeline' )),
    COMMETHOD([helpstring('method GetPriority')], HRESULT, 'GetPriority',
              ( [], POINTER(c_int), 'pPriority' )),
    COMMETHOD([helpstring('method GetMediaType')], HRESULT, 'GetMediaType',
              ( ['out'], POINTER(_AMMediaType), '__MIDL__IAMTimelineGroup0000' )),
    COMMETHOD([helpstring('method SetMediaType')], HRESULT, 'SetMediaType',
              ( ['in'], POINTER(_AMMediaType), '__MIDL__IAMTimelineGroup0001' )),
    COMMETHOD([helpstring('method SetOutputFPS')], HRESULT, 'SetOutputFPS',
              ( [], c_double, 'FPS' )),
    COMMETHOD([helpstring('method GetOutputFPS')], HRESULT, 'GetOutputFPS',
              ( [], POINTER(c_double), 'pFPS' )),
    COMMETHOD([helpstring('method SetGroupName')], HRESULT, 'SetGroupName',
              ( [], BSTR, 'pGroupName' )),
    COMMETHOD([helpstring('method GetGroupName')], HRESULT, 'GetGroupName',
              ( ['out', 'retval'], POINTER(BSTR), 'pGroupName' )),
    COMMETHOD([helpstring('method SetPreviewMode')], HRESULT, 'SetPreviewMode',
              ( [], c_int, 'fPreview' )),
    COMMETHOD([helpstring('method GetPreviewMode')], HRESULT, 'GetPreviewMode',
              ( [], POINTER(c_int), 'pfPreview' )),
    COMMETHOD([helpstring('method SetMediaTypeForVB')], HRESULT, 'SetMediaTypeForVB',
              ( ['in'], c_int, 'Val' )),
    COMMETHOD([helpstring('method GetOutputBuffering')], HRESULT, 'GetOutputBuffering',
              ( ['out'], POINTER(c_int), 'pnBuffer' )),
    COMMETHOD([helpstring('method SetOutputBuffering')], HRESULT, 'SetOutputBuffering',
              ( ['in'], c_int, 'nBuffer' )),
    COMMETHOD([], HRESULT, 'SetSmartRecompressFormat',
              ( [], POINTER(c_int), 'pFormat' )),
    COMMETHOD([], HRESULT, 'GetSmartRecompressFormat',
              ( [], POINTER(POINTER(c_int)), 'ppFormat' )),
    COMMETHOD([], HRESULT, 'IsSmartRecompressFormatSet',
              ( [], POINTER(c_int), 'pVal' )),
    COMMETHOD([], HRESULT, 'IsRecompressFormatDirty',
              ( [], POINTER(c_int), 'pVal' )),
    COMMETHOD([], HRESULT, 'ClearRecompressFormatDirty'),
    COMMETHOD([], HRESULT, 'SetRecompFormatFromSource',
...
IDxtKey._methods_ = [
    COMMETHOD([dispid(1), helpstring('property KeyType'), 'propget'], HRESULT, 'KeyType',
              ( ['out', 'retval'], POINTER(c_int), '__MIDL__IDxtKey0000' )),
    COMMETHOD([dispid(1), helpstring('property KeyType'), 'propput'], HRESULT, 'KeyType',
              ( ['in'], c_int, '__MIDL__IDxtKey0000' )),
    COMMETHOD([dispid(2), helpstring('property Hue'), 'propget'], HRESULT, 'Hue',
              ( ['out', 'retval'], POINTER(c_int), '__MIDL__IDxtKey0002' )),
    COMMETHOD([dispid(2), helpstring('property Hue'), 'propput'], HRESULT, 'Hue',
              ( ['in'], c_int, '__MIDL__IDxtKey0002' )),
    COMMETHOD([dispid(3), helpstring('property Luminance'), 'propget'], HRESULT, 'Luminance',
              ( ['out', 'retval'], POINTER(c_int), '__MIDL__IDxtKey0004' )),
    COMMETHOD([dispid(3), helpstring('property Luminance'), 'propput'], HRESULT, 'Luminance',
              ( ['in'], c_int, '__MIDL__IDxtKey0004' )),
    COMMETHOD([dispid(4), helpstring('property RGB'), 'propget'], HRESULT, 'RGB',
              ( ['out', 'retval'], POINTER(c_ulong), '__MIDL__IDxtKey0006' )),
    COMMETHOD([dispid(4), helpstring('property RGB'), 'propput'], HRESULT, 'RGB',
              ( ['in'], c_ulong, '__MIDL__IDxtKey0006' )),
    COMMETHOD([dispid(5), helpstring('property Similarity'), 'propget'], HRESULT, 'Similarity',
              ( ['out', 'retval'], POINTER(c_int), '__MIDL__IDxtKey0008' )),
    COMMETHOD([dispid(5), helpstring('property Similarity'), 'propput'], HRESULT, 'Similarity',
              ( ['in'], c_int, '__MIDL__IDxtKey0008' )),
    COMMETHOD([dispid(6), helpstring('property Invert'), 'propget'], HRESULT, 'Invert',
              ( ['out', 'retval'], POINTER(c_int), '__MIDL__IDxtKey0010' )),
    COMMETHOD([dispid(6), helpstring('property Invert'), 'propput'], HRESULT, 'Invert',
...
__all__ = [ 'IGrfCache', 'IGraphBuilder', 'IAMTimelineTrack',
           'IBaseFilter', '_PinDirection', 'IEnumFilters',
           'IAMSetErrorLog', 'IReferenceClock', 'IDXEffect',
           'AMTimelineTrans', 'AMTimelineTrack', 'IPersistStream',
           'ColorSource', 'LONG_PTR', 'TIMELINE_MAJOR_TYPE_SOURCE',
           'AMTimelineObj', '__MIDL___MIDL_itf_qedit_0000_0000_0003',
           'AMTimelineSrc', 'IAMTimelineEffect', 'IAMTimelineComp',
           'IFindCompressorCB', 'IMediaLocator', 'NullRenderer',
           'IRenderEngine2', 'IResize', 'IXml2Dex', 'IRenderEngine',
           'IPropertySetter', 'SmartRenderEngine', 'IDxtAlphaSetter',
           'DxtCompositor', 'IDxtCompositor', 'IMediaFilter',
           'TIMELINE_MAJOR_TYPE', 'IDxtKey', 'ISampleGrabber',
           'DEXTER_VALUE', '__MIDL___MIDL_itf_qedit_0000_0000_0007',
           'IAMTimelineTrans', 'IDxtJpeg', 'DxtKey',
           'TIMELINE_MAJOR_TYPE_GROUP', 'TIMELINE_MAJOR_TYPE_TRACK',
           'AMTimeline', 'DEXTER_PARAM', 'IAMTimelineSplittable',
           'AudMixer', '_AMMediaType', 'ISampleGrabberCB',
           'IFilterGraph', 'AMTimelineEffect', '_PinInfo',
           'RenderEngine', 'IAMTimelineEffectable',
           'IAMTimelineVirtualTrack', '_FilterInfo', 'State_Paused',
           'DxtJpeg', 'MediaDet', 'IMediaDet', 'IEnumPins',
           'MediaLocator', 'IStream', 'IPin', 'IAMTimeline',
           'IAMTimelineSrc', 'SampleGrabber', 'PropertySetter',
           'IAMErrorLog', 'AMTimelineComp', 'ISequentialStream',
           '__MIDL___MIDL_itf_qedit_0000_0000_0002',
           'IEnumMediaTypes', 'AMTimelineGroup', 'PINDIR_INPUT',
           'DxtAlphaSetter', 'State_Running',
           'TIMELINE_MAJOR_TYPE_COMPOSITE', 'IAMTimelineObj',
           'TIMELINE_MAJOR_TYPE_TRANSITION', 'IAMTimelineTransable',
           'tagSTATSTG', 'PINDIR_OUTPUT', 'IMediaSample', 'Xml2Dex',
           'State_Stopped', '_FilterState',
           'TIMELINE_MAJOR_TYPE_EFFECT', 'IAMTimelineGroup',
           'ISmartRenderEngine']
from comtypes import _check_version; _check_version('1.1.11', 1611459632.6901288)
